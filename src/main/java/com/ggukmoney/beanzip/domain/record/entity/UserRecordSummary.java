...
@Getter
@Entity
@Table(name = "user_record_summary")
...
public class UserRecordSummary {
    ...
    @Column(name = "total_tap_count", nullable = false)
    private Long totalTapCount = 0L;

    @Column(name = "total_point_amount", nullable = false)
    private Long totalPointAmount = 0L;
