...
- `app_config` 유효 설정 조회: `config_key/effective_at` 기준 Repository 메서드와 Controller가 없다.
...
- `user_keycap.equipped=true`와 `status=COMPLETED` 정합성
